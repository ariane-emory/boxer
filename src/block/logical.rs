...
////////////////////////////////////////////////////////////////////////////////
impl SteppableWithOutputSignal<bool> for Or {
...
////////////////////////////////////////////////////////////////////////////////
impl SteppableWithOutputSignal<bool> for And {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
...
////////////////////////////////////////////////////////////////////////////////
impl SteppableWithOutputSignal<bool> for Xor {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
...
////////////////////////////////////////////////////////////////////////////////
impl SteppableWithOutputSignal<bool> for Nor {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
...
////////////////////////////////////////////////////////////////////////////////
impl SteppableWithOutputSignal<bool> for Not {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
