...
////////////////////////////////////////////////////////////////////////////////
impl<T: std::cmp::PartialOrd + Copy> SteppableOutputSignal<bool> for GreaterThan<T> {
...
////////////////////////////////////////////////////////////////////////////////
impl<T: std::cmp::PartialOrd + Copy> SteppableOutputSignal<bool> for LessThan<T> {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
...
////////////////////////////////////////////////////////////////////////////////
impl<T: std::cmp::PartialEq + Copy> SteppableOutputSignal<bool> for Equal<T> {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
...
////////////////////////////////////////////////////////////////////////////////
impl<T: std::cmp::PartialEq + Copy> SteppableOutputSignal<bool> for NotEqual<T> {
  fn output(&self) -> &SignalRef<bool> {
    &self.output
  }
}
