...
pub trait Positional: Clone + Copy + Eq + PartialEq + Ord + PartialOrd + Sized {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn height(&self) -> usize { self.bottom_right().line - self.top_left().line + 1 }

  fn width(&self) -> usize { self.bottom_right().col - self.top_left().col + 1 }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn size(&self) -> Size { Size::new(self.height(), self.width()) }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn area(&self) -> usize { self.size().area() }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn left_bound(&self) -> usize { self.top_left().col }

  fn right_bound(&self) -> usize { self.bottom_right().col }

  fn upper_bound(&self) -> usize { self.top_left().line }

  fn lower_bound(&self) -> usize { self.bottom_right().line }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn is_left_aligned_with(&self,
                          other: &impl Positional)
                          -> bool {
    self.left_bound() == other.left_bound()
  }

  fn is_right_aligned_with(&self,
                           other: &impl Positional)
                           -> bool {
    self.right_bound() == other.right_bound()
  }

  fn is_top_aligned_with(&self,
                         other: &impl Positional)
                         -> bool {
    self.upper_bound() == other.upper_bound()
  }

  fn is_bottom_aligned_with(&self,
                            other: &impl Positional)
                            -> bool {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  fn top_right(&self) -> Point { Point::new(self.top_left().line, self.bottom_right().col) }

  fn bottom_left(&self) -> Point { Point::new(self.bottom_right().line, self.top_left().col) }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn point_is_corner(&self,
                     point: &Point)
                     -> bool {
    point == &self.top_left()
