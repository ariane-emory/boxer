...
pub trait LineMethods: Positional {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn start(&self) -> Point { self.top_left() }

  fn end(&self) -> Point { self.bottom_right() }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn points(&self) -> (Point, Point) { (self.start(), self.end()) }
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn is_horizontal(&self) -> bool { self.size().is_wide() }

  fn is_vertical(&self) -> bool { self.size().is_tall() }

  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn is_parallel_to(&self,
                    other: &Self)
                    -> bool {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn is_horizontally_coaligned_with(&self,
                                    other: &Self)
                                    -> bool {
    self.is_horizontal()
    && other.is_horizontal()
  ...
  fn is_vertically_coaligned_with(&self,
                                  other: &Self)
                                  -> bool {
    self.is_vertical()
    && other.is_vertical()
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  fn length(&self) -> usize { self.size().area() }
  ...
  fn is_connected_to<T: LineMethods>(&self,
                                     other_line: &T)
                                     -> bool {
